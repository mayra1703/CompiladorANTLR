...
public class CommonLexerRules extends Lexer {
	...
	public static final int
		TYPE=1, PLUS=2, MINUS=3, MULT=4, DIV=5, MOD=6, IGUAL=7, OC=8, OL=9, OR=10, 
		AND=11, MATH_EQUALS=12, SERENITYCLASS=13, COZYCONDITION=14, TWILIGHTOPTION=15, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TYPE", "PLUS", "MINUS", "MULT", "DIV", "MOD", "IGUAL", "OC", "OL", "OR", 
			"AND", "MATH_EQUALS", "SERENITYCLASS", "COZYCONDITION", "TWILIGHTOPTION", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OR", "AND", "MATH_EQUALS", "SERENITYCLASS", "COZYCONDITION", "TWILIGHTOPTION", 
			"ELSE", "DREAMYELSE", "DREAMLOOP", "DO", "ARROW", "WHISPER", "INITKEY", 
			"FINALKEY", "GATITO", "PUNTITO", "STARSTRING", "NUM", "CHAR", "FLOAT", 
			"ID", "LINECOMMENT", "COMMENT", "NEWLINE", "SPACES", "COMA"
		};
