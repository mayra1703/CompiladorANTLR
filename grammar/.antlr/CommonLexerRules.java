...
public class CommonLexerRules extends Lexer {
	...
	public static final int
		...
		SWEET=10, SWEETCONDITION=11, ELSE=12, IF=13, ARROW=14, SHOW=15, INITKEY=16, 
		FINALKEY=17, GATITO=18, PUNTITO=19, NUM=20, ID=21, WRONGID=22, LINECOMMENT=23, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SWEET", "SWEETCONDITION", "ELSE", "IF", "ARROW", "SHOW", "INITKEY", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BOOL", "SWEET", "SWEETCONDITION", "ELSE", "IF", "ARROW", "SHOW", "INITKEY", 
			"FINALKEY", "GATITO", "PUNTITO", "NUM", "ID", "WRONGID", "LINECOMMENT", 
			"COMMENT", "NEWLINE", "SPACES"
		};
	}
