...
public class CommonLexerRules extends Lexer {
	...
	public static final int
		TYPE=1, PLUS=2, MINUS=3, TIMES=4, DIV=5, SWEET=6, PUNTITO=7, NUM=8, ID=9, 
		WRONGID=10, NEWLINE=11, SPACES=12;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TYPE", "PLUS", "MINUS", "TIMES", "DIV", "SWEET", "PUNTITO", "NUM", "ID", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "TYPE", "PLUS", "MINUS", "TIMES", "DIV", "SWEET", "PUNTITO", "NUM", 
			"ID", "WRONGID", "NEWLINE", "SPACES"
		};
	}
