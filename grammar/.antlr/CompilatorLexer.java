...
public class CompilatorLexer extends Lexer {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, SWEET=7, PUNTITO=8, ID=9, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "SWEET", "PUNTITO", "ID", 
			"NEWLINE", "SPACES"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'{'", "'}'", "'#'", "'mint'", "'mintchar'", "'mintflot'", "'Sweet'", 
			"'.'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, "SWEET", "PUNTITO", "ID", "NEWLINE", 
			"SPACES"
		};
	}
