...
public class CParser extends Parser {
	...
	public static final int
		...
		DIV=9, MOD=10, IGUAL=11, OC=12, OL=13, MATH_EQUALS=14, VOID=15, MAIN=16, 
		INITPAR=17, FINALPAR=18, IF=19, ELSE=20, DO=21, WHILE=22, PRINTF=23, INITKEY=24, 
		FINALKEY=25, SEMI=26, INT=27, CHAR=28, FLOAT=29, ID=30, INV_ID=31, NEWLINE=32, 
		SPACES=33, LINE_COMMENT=34, COMA=35;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'='", null, null, null, "'void'", "'main'", "'('", "')'", "'if'", "'else'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MULT", "DIV", "MOD", "IGUAL", "OC", "OL", "MATH_EQUALS", "VOID", "MAIN", 
			"INITPAR", "FINALPAR", "IF", "ELSE", "DO", "WHILE", "PRINTF", "INITKEY", 
			"FINALKEY", "SEMI", "INT", "CHAR", "FLOAT", "ID", "INV_ID", "NEWLINE", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1086849026L) != 0)) {
				{
				{
				setState(41);
				contenido();
	...
	public static class AsignacionContext extends ParserRuleContext {
		...
		public TerminalNode SEMI() { return getToken(CParser.SEMI, 0); }
		public TerminalNode IGUAL() { return getToken(CParser.IGUAL, 0); }
		public TerminalNode MATH_EQUALS() { return getToken(CParser.MATH_EQUALS, 0); }
	...
	public final AsignacionContext asignacion() throws RecognitionException {
		...
		try {
			...
			match(ID);
			setState(68);
			((AsignacionContext)_localctx).eq = _input.LT(1);
			_la = _input.LA(1);
			if ( !(_la==IGUAL || _la==MATH_EQUALS) ) {
				((AsignacionContext)_localctx).eq = (Token)_errHandler.recoverInline(this);
			}
			else {
